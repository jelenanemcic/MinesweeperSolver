...
Grafičko sučelje implementirano je koristeći programsku biblioteku Tkinter. Na slici \ref{img:GUI} prikazan je primjer grafičkog sučelja.
...
U ovom trenutku su svi vanjski paketi preuzeti i moguće je pokrenuti aplikaciju
\begin{verbatim}
$ python3 driver.py
\end{verbatim}
...
S druge strane, 3-SAT algoritam prilikom rješavanja pozicija koje nisu jednoznačne može
odmah razriješiti polja koja su jednoznačna, a ostala polja riješiti kasnije kad
postanu jednoznačna. Iz ovog razloga je 3-SAT puno bolji algoritam za rješavanje ovog
problema. Međutim, prednost simpleks postupka nad 3-SAT algoritmom je u vremenskoj složenosti.
